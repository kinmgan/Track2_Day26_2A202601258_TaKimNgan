...
if __name__ == "__main__":
    ...
    expected_bankrupt = ROUNDS_PER_DUEL if (disciplined * ROUNDS_PER_DUEL > 100) else None
    assert disciplined_pacer.bankrupt_by() == expected_bankrupt, disciplined_pacer.bankrupt_by()
